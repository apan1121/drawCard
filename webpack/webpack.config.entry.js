...
if (1) {
    ...
    const MP3_FONT_DIR = path.resolve(__dirname, '../src/mp3/');
    const MP3_FONT_PUBLIC_DIR = path.resolve(__dirname, `${PUBLIC_DIR}/mp3/`);
    ...
    copyEntry[MP3_FONT_DIR] = MP3_FONT_PUBLIC_DIR;
